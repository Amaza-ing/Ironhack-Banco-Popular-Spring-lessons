package com.ironhack.w6d1academy.service.impl;

import com.ironhack.w6d1academy.model.Course;
import com.ironhack.w6d1academy.repository.CourseRepository;
import com.ironhack.w6d1academy.service.interfaces.ICourseService;
...
public class CourseService implements ICourseService {
    ...
    public void saveCourse(Course course) {
        ...
        if (courseOptional.isPresent()) throw new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY, "The course already exists");
